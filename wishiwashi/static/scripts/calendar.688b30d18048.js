      ...
      return (
            ...
            this.props.entries.map(function(entry, index){
                ...
                return (React.createElement("div", {key: 'e5' + row + day + index, style: style, className: "row"}, 
                            React.createElement("div", {className: "col-xs-12"}, entry.order), 
                            React.createElement("div", {className: "col-xs-12"}, React.createElement("small", null, entry.postcode))
                        ));
            })
            )
      );
...
var Slot = React.createClass({displayName: "Slot",
  render: function() {
    ...
    return (
        React.createElement("div", {key: this.props.row + ',' + this.props.id, className: "col-xs-2 text-center success"}, 
